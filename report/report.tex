...
\section{Regular Denoising Diffusion Probabilistic Model (DDPM)}

Describe this model and the training algorithm.

\section{Training the Model on the MNIST Dataset}

Describe the training process and the results. FID and IS scores.
